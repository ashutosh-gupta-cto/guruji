...
export const tracks: Track[] = [
  {
    ...
    lessons: [
      ...
      },
      {
        id: 'quick-sort',
        title: 'Quick Sort',
        description: 'Partition around a pivot and recurse on left and right subarrays.',
        duration: '16 min',
        labModule: 'quick-sort',
        difficulty: 'intermediate',
      },
      {
        id: 'binary-search',
      ...
      },
      {
        ...
        description: 'Find single-source shortest paths with a min-priority queue.',
        duration: '22 min',
        labModule: 'dijkstra',
        difficulty: 'advanced',
      },
      {
        id: 'stack-queue',
        title: 'Stack & Queue',
        description: 'LIFO push/pop and FIFO enqueue/dequeue with overflow checks.',
        duration: '14 min',
        labModule: 'stack-queue',
        difficulty: 'beginner',
      },
      {
        id: 'linked-list',
        title: 'Singly Linked List',
        description: 'Insert at tail and delete by value with pointer traversal.',
        duration: '16 min',
        labModule: 'linked-list',
        difficulty: 'beginner',
      },
      {
        id: 'trie',
        title: 'Trie (Prefix Tree)',
        description: 'Insert, search, and autocomplete words character by character.',
        duration: '18 min',
        labModule: 'trie',
        difficulty: 'intermediate',
      },
      {
        ...
        description: "Compare Prim's and Kruskal's algorithms on weighted graphs.",
        duration: '20 min',
        labModule: 'mst',
        difficulty: 'advanced',
      },
  ...
  },
  {
    ...
    lessons: [
      ...
      },
      {
        ...
        description: 'Walk through prepare, promise, accept, and learn phases step by step.',
        duration: '22 min',
        labModule: 'paxos',
        difficulty: 'advanced',
      },
      {
        ...
        description: 'Simulate retry storms and watch overload persist after recovery.',
        duration: '20 min',
        labModule: 'stability',
        difficulty: 'advanced',
      },
      {
        ...
        description: 'Design URL shortener, news feed, or chat — drag components and get scored.',
        duration: '30 min',
        labModule: 'interview-simulator',
        difficulty: 'intermediate',
      },
    ],
  },
  {
    ...
    lessons: [
      ...
      },
      {
        ...
        description: 'Scrub through denoising steps and see how latent noise becomes an image.',
        duration: '26 min',
        labModule: 'diffusion',
        difficulty: 'intermediate',
      },
      ...
      },
      {
        ...
        description: 'Compare vector-only, graph-only, and hybrid retrieval on knowledge graphs.',
        duration: '24 min',
        labModule: 'graphrag-hybrid',
        difficulty: 'advanced',
      },
    ],
  },
  {
    ...
    lessons: [
      ...
      },
      {
        ...
        description:
          'Complete interactive levels — commit, branch, merge, rebase, and cherry-pick on a live graph.',
        duration: '25 min',
        labModule: 'git-game',
        difficulty: 'intermediate',
      },
      {
        ...
        description:
          'Step through RISC-V assembly in Ripes — registers, memory, pipeline, and cache.',
        duration: '20 min',
        labModule: 'cpu-arch',
        difficulty: 'intermediate',
      },
      {
        ...
        title: 'Cipher Museum',
        description:
          'Encrypt and decrypt with Caesar, Vigenère, Playfair, Rail Fence, and simplified Enigma.',
        duration: '18 min',
        labModule: 'cipher-museum',
        difficulty: 'beginner',
      },
      {
        id: 'os-simulator',
        ...
        description:
          'Translate virtual addresses and compare FIFO, LRU, and OPT page replacement.',
        duration: '20 min',
        labModule: 'os-simulator',
        difficulty: 'intermediate',
      },
    ],
  },
